...
class HrApplicantEvaluation(models.Model):
    ...
    #marlins_proficiency = fields.Selection(SCORE_MARK, 'Service Minded')
    #listening = fields.Selection(SCORE_MARK, 'Listening')
    #grammar = fields.Selection(SCORE_MARK, 'Grammar')
    #vocabulary = fields.Selection(SCORE_MARK, 'Vocabulary')    

    #time_number = fields.Selection(SCORE_MARK, 'Time and Number')
    #readings = fields.Selection(SCORE_MARK, 'Readings')
    #pronounciation = fields.Selection(SCORE_MARK, 'Pronounciation')

    #overall_english_spoken = fields.Selection(SCORE_MARK, 'Overall level of English Spoken')
