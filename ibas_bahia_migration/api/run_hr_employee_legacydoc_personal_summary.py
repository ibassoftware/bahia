...
# UPDATE employee legacy documents: personal_summary
def update_employee_legacydoc_personal_summary():
	...
	if get_employee:
		for employee in get_employee:
			check_args = [('id', '=', employee),('is_legacy_doc_mig_3', '=', False)]
...
update_employee_legacydoc_personal_summary()