...
class hrPersonnelActiveOnBoardwithRemarksMenuMainView(models.Model):
    ...
    def genReport(self):
        return self.env.ref['ibas_bahia.action_report_personnel_active_on_board_with_remarks'].report_action(self, context=context)
...
class hrDisembarkationMenuMainView(models.Model):
    ...
    def genReport(self, cr, uid, ids, context=None):
        return self.pool['report'].get_action(cr, uid, ids, 'bahia_personnel_management.report_disembarkation', context=context)
