...
class BahiasApplicationForm(http.Controller):
    ...
    def jobs(self, country=None, department=None, office_id=None, **kwargs):
        ...
        model_principal = env['res.partner'].sudo().search([('is_company','=', 1)])
        ...
        # Render page
        return request.render("ibas_bahia_website.ibas_bahia_recruitment_index", {
            'jobs': jobs,
    ...
    def jobs_detail(self, job, **kwargs):
        return request.render("ibas_bahia_website.detail", {
            'job': job,
            'main_object': job,
        })
    ...
    def start_apply(self):
        ...
        #return request.render("ibas_bahia_website.start_apply", {})
    ...
    def jobs_start_privacy_policy(self):
        ...
        return request.render("ibas_bahia_website.apply_privacy_policy", {
            'error': error,
            'default': default,
            'jobs':model_jobs,
            'with_jobs': 0,
    ...
    def jobs_apply_all(self, applicant):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_all", {
    ...
    def jobs_apply_add_family_details(self, new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_family_details", {
    ...
    def add_educ_back_details(self, new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_educational_background", {
    ...
    def jobs_apply_add_documents(self, new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_documents", {
    ...
    def jobs_apply_add_denied_visa(self, new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_denied_visa", {
            'applicant':applicant_document_obj,
            'new_applicant_id':new_applicant_id,
    ...
    def jobs_apply_add_deported(self, new_applicant_id, update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_deported", {
            'applicant':applicant_document_obj,
            'new_applicant_id':new_applicant_id,
            'nationality_ids': country_all,
            'update_only': update_only,
    ...
    def jobs_apply_add_training_courses(self, new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_training_courses", {
    ...
    def jobs_apply_add_license(self, new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_license", {
            'trainings':applicant_license,
            'applicant':applicant_document_obj,
            'new_applicant_id':new_applicant_id,
            'error': error,
    ...
    def jobs_apply_add_medical_history(self, new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_medical_history", {
            'applicant':applicant_document_obj,
            'new_applicant_id':new_applicant_id,
            'update_only':update_only,
            'error': error,
    ...
    def jobs_apply_add_medical_operation(self, new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_medical_operation", {
            'applicant':applicant_document_obj,
            'new_applicant_id':new_applicant_id,
            'update_only':update_only,
            'error': error,
    ...
    def jobs_apply_add_medical_illness(self, new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_medical_illness", {
            'applicant':applicant_document_obj,
            'new_applicant_id':new_applicant_id,
            'update_only':update_only,
            'error': error,
    ...
    def jobs_apply_add_employee_relatives(self, new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_employee_relatives", {
            'applicant':applicant_document_obj,
            'new_applicant_id':new_applicant_id,
            'error': error,
            'update_only':update_only,
    ...
    def jobs_apply_add_previous_application(self, new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_previous_application", {
            'applicant':applicant_document_obj,
            'new_applicant_id':new_applicant_id,
            'error': error,
            'update_only':update_only,
    ...
    def jobs_apply_add_employment_history(self, new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_add_employment_history", {
            'applicant':applicant_document_obj,
            'new_applicant_id':new_applicant_id,
            'error': error,
            'update_only':update_only,
    ...
    def apply_all_3_execute(self,**post):
        ...
        if passport_error_notify == 1:
            ...
            if 'ibas_bahia_website_error' in request.session:
                error = request.session.pop('ibas_bahia_website_error')
                default = request.session.pop('ibas_bahia_website_default')  
            return request.render("ibas_bahia_website.apply_all_2", 
                                 {'applicant':application_obj,
    ...
    def jobs_apply_all_2(self,applicant):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')  
        return request.render("ibas_bahia_website.apply_all_2", {'applicant':applicant.sudo()})   
...
#UPDATE UPON FINAL SUBMISSION FORM
    ...
    def jobs_apply_all_3_update(self,new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')  
        return request.render("ibas_bahia_website.apply_all_3", 
            {
                'applicant':applicant_obj.sudo(),
                'error': error,
                'update_only': update_only,
    ...
    def jobs_apply_all_4_update(self,new_applicant_id,update_only):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')  
        return request.render("ibas_bahia_website.apply_all_4", 
            {
                'applicant':applicant_obj.sudo(),
                'update_only': update_only,
            })
    ...
    def jobs_apply_all_4(self,applicant):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_all_4", {'applicant':applicant.sudo()})   
    ...
    def jobs_apply(self, job):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        # return request.render("ibas_bahia_website.apply", {
    ...
    def jobs_apply_all_summary(self,applicant):
        ...
        if 'ibas_bahia_website_error' in request.session:
            error = request.session.pop('ibas_bahia_website_error')
            default = request.session.pop('ibas_bahia_website_default')
        return request.render("ibas_bahia_website.apply_all_summary", {'applicant':applicant.sudo()})   
...
#Final Form
    ...
    def jobs_thankyou(self, **post):
        ...
        if error:
            request.session['ibas_bahia_website_error'] = error
            #ufile = post.pop('ufile')
            #if ufile:
            #    error['ufile'] = 'reset'
            #request.session['ibas_bahia_website_default'] = post
        ...
        #    }
        #    env['ir.attachment'].create(attachment_value)
        return request.render("ibas_bahia_website.thankyou", {})
#============================== THIS WILL ADD NEW FORM FUNCTIONS ETC
    ...
    def jobs_apply_add_socmedia_details(self, new_applicant_id,update_only, **kw):
        ...
        return request.render("ibas_bahia_website.apply_add_socialmedia_details", {
